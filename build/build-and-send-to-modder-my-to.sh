...
sudo -v
echo "Dev"
time ./build/build.sh -bt dev -v $VERSION_CODE -ir $BUILD_STACK
...
sudo -v
echo "OSKR"
time ./build/build.sh -bt oskr -bp $oskr_boot_password -v $VERSION_CODE -ir $BUILD_STACK
...
sudo -v
echo "Prod"
time ./build/build.sh -bt proddev -s -op $OTA_PASS -bp $prod_boot_password -v $VERSION_CODE -ir $BUILD_STACK
...
sudo -v
echo "Dev Cloudless"
time ./build/build.sh -bt devcloudless -v $VERSION_CODE -ir $BUILD_STACK
...
sudo -v
echo "OSKR Cloudless"
time ./build/build.sh -bt oskrcloudless -bp $oskr_boot_password -v $VERSION_CODE -ir $BUILD_STACK
...
sudo -v
echo "Prod Cloudless"
time ./build/build.sh -bt prodcloudless -s -op $OTA_PASS -bp $prod_boot_password -v $VERSION_CODE -ir $BUILD_STACK
